...
// Lazarus Data Store
// Network
// 'remove_object_request_handler.cc'
// Author: jcjuarez
// Description:
...
#include "remove_object_request_handler.hh"
...
remove_object_request_handler::remove_object_request_handler(
...
void
remove_object_request_handler::execute_operation(
